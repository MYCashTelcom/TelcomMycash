...
public partial class MIS_frmMBL_Various_MIS_Report_3_1 : System.Web.UI.Page
{
    ...
    #region MAXIS TOTAL REPORT
    //ADDED BY CHAMAK ON 12/09/20121

    protected void btnMaxisTotal_Click(object sender, EventArgs e)
    {
        try
        {
            string strSql = "";

            strSql = "SELECT TO_CHAR(TRAN_DATE) TRAN_DATE, GET_RANK_WISE_BALANCE_BY_DATE('200903000000000001', TRAN_DATE) MAXIS_MERCHANT, GET_RANK_WISE_BALANCE_BY_DATE('200813000000000002', TRAN_DATE) MAXIS_DISTRIBUTOR, GET_RANK_WISE_BALANCE_BY_DATE('200813000000000001', TRAN_DATE) MAXIS_MASTER_DISTRIBUTOR, GET_RANK_WISE_BALANCE_BY_DATE('200813000000000003', TRAN_DATE) MAXIS_DSE, GET_RANK_WISE_BALANCE_BY_DATE('200813000000000004', TRAN_DATE) MAXIS_AGENT, GET_RANK_WISE_BALANCE_BY_DATE('200813000000000005', TRAN_DATE) MAXIS_MOTHER_MERCHANT, GET_TOTAL_CUST_BAL_BY_AGENT('200813000000000004', TRAN_DATE) MAXIS_CUSTOMER FROM (SELECT TRUNC(CAT.CAS_TRAN_DATE) TRAN_DATE FROM ACCOUNT_LIST AL, ACCOUNT_RANK AR, BDMIT_ERP_101.CAS_ACCOUNT_LIST CAL, BDMIT_ERP_101.VW_CAS_ACCOUNT_TRANSACTION CAT WHERE AL.ACCNT_NO = CAL.CAS_ACC_NO AND CAL.CAS_ACC_ID = CAT.CAS_ACC_ID AND AL.ACCNT_RANK_ID = AR.ACCNT_RANK_ID AND AL.ACCNT_RANK_ID IN ('200813000000000005', '200813000000000003', '200813000000000002', '200813000000000003', '200813000000000004','200903000000000001','200813000000000001') AND TRUNC(CAT.CAS_TRAN_DATE) BETWEEN '" + fromDateMaxisTotal.DateString + "' AND '" + toDateMaxisTotal.DateString + "' GROUP BY TRUNC(CAT.CAS_TRAN_DATE)) ORDER BY TRAN_DATE ";
            ...
            DataSet dtsAccount = new DataSet();
            fileName = "RankWiseMaxisBalance_Rpt";
            string strDate = fromDateMaxisTotal.DateString + " To " + toDateMaxisTotal.DateString;
            //------------------------------------------Report File xl processing   -------------------------------------
            ...
            strHTML = strHTML + "</table>";
            strHTML = strHTML + "<table border=\"0\" width=\"100%\">";
            strHTML = strHTML + "<tr><td COLSPAN=10 align=center style='border-right:none;font-size:14px;font-weight:bold;'><h4 align=center>Rank Wise Maxis Balance Detail ('" + strDate + "'  )</h2></td></tr>";
            strHTML = strHTML + "</table>";
            ...
            strHTML = strHTML + "<td valign='middle' >Sl</td>";
            strHTML = strHTML + "<td valign='middle' >TRANSACTION DATE</td>";
            strHTML = strHTML + "<td valign='middle' >MAXIS DISTRIBUTOR</td>";
            strHTML = strHTML + "<td valign='middle' >MAXIS MASTER DISTRIBUTOR</td>";
            strHTML = strHTML + "<td valign='middle' >MAXIS DSE</td>";
            strHTML = strHTML + "<td valign='middle' >MAXIS AGENT</td>";
            strHTML = strHTML + "<td valign='middle' >MAXIS MERCHANT</td>";
            strHTML = strHTML + "<td valign='middle' >MAXIS MOTHER MERCHANT</td>";
            ...
            if (dtsAccount.Tables[0].Rows.Count > 0)
            {
                ...
                foreach (DataRow prow in dtsAccount.Tables[0].Rows)
                {
                    ...
                    strHTML = strHTML + " <td > '" + prow["MAXIS_DISTRIBUTOR"].ToString() + " </td>";
                    strHTML = strHTML + " <td > '" + prow["MAXIS_MASTER_DISTRIBUTOR"].ToString() + "</td>";
                    strHTML = strHTML + " <td > '" + prow["MAXIS_DSE"].ToString() + "</td>";
                    strHTML = strHTML + " <td > '" + prow["MAXIS_AGENT"].ToString() + " </td>";
                    strHTML = strHTML + " <td > '" + prow["MAXIS_MERCHANT"].ToString() + " </td>";
                    strHTML = strHTML + " <td > '" + prow["MAXIS_MOTHER_MERCHANT"].ToString() + "</td>";
                    strHTML = strHTML + " <td > '" + (Convert.ToDecimal(prow["MAXIS_MERCHANT"])
                                                    + Convert.ToDecimal(prow["MAXIS_DISTRIBUTOR"])
                                                    + Convert.ToDecimal(prow["MAXIS_MASTER_DISTRIBUTOR"])
                                                    + Convert.ToDecimal(prow["MAXIS_DSE"])
                                                    + Convert.ToDecimal(prow["MAXIS_AGENT"])
                                                    + Convert.ToDecimal(prow["MAXIS_MOTHER_MERCHANT"])).ToString()
                                                    + "</td>";
                    strHTML = strHTML + " </tr> ";
                    SerialNo = SerialNo + 1;
                }
            ...
            SaveAuditInfo("Preview", "MAXIS TOTAL REPORT ");
            clsGridExport.ExportToMSExcel(fileName, "msexcel", strHTML, "landscape");
    ...
    protected void btnBusinessCollection_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string type = "NOT LIKE " + "'%Sadar%'";
            string gender = "'M'";


            string MU = objServiceHandler.getBBankFMReportData(dtpBcFrom.DateString, dtpBcTo.DateString, " LIKE " + "'%Sadar%' ", "'M'");
            string MR = objServiceHandler.getBBankFMReportData(dtpBcFrom.DateString, dtpBcTo.DateString, " NOT LIKE " + "'%Sadar%' ", "'M' ");
            string FU = objServiceHandler.getBBankFMReportData(dtpBcFrom.DateString, dtpBcTo.DateString, " LIKE " + "'%Sadar%' ", "'F' ");
            string FR = objServiceHandler.getBBankFMReportData(dtpBcFrom.DateString, dtpBcTo.DateString, " NOT LIKE " + "'%Sadar%' ", "'F' ");
            string OTU = objServiceHandler.getBBankFMReportData(dtpBcFrom.DateString, dtpBcTo.DateString, " LIKE " + "'%Sadar%' ", "'O' ");
            string OTR = objServiceHandler.getBBankFMReportData(dtpBcFrom.DateString, dtpBcTo.DateString, " NOT LIKE " + "'%Sadar%' ", "'O' ");
            string[] arrMU = MU.Split('*');
            string[] arrMR = MR.Split('*');
            string[] arrFU = FU.Split('*');
            string[] arrFR = FR.Split('*');
            string[] arrOU = OTU.Split('*');
            string[] arrOR = OTR.Split('*');
            ...
            strHTML = strHTML + " <tr><td >" + 1 + "</td>";
            strHTML = strHTML + " <td > " + "Urban" + "</td>";
            strHTML = strHTML + " <td > " + "Male" + "</td>";
            strHTML = strHTML + " <td > " + arrMU[0].ToString() + "</td>";
            strHTML = strHTML + " <td > " + arrMU[1].ToString() + " </td>";

            strHTML = strHTML + " <tr><td >" + 2 + "</td>";
            strHTML = strHTML + " <td > " + "Rural" + "</td>";
            strHTML = strHTML + " <td > " + "Male" + "</td>";
            strHTML = strHTML + " <td > " + arrMR[0].ToString() + "</td>";
            strHTML = strHTML + " <td > " + arrMR[1].ToString() + " </td>";

            strHTML = strHTML + " <tr><td >" + 3 + "</td>";
            strHTML = strHTML + " <td > " + "Urban" + "</td>";
            strHTML = strHTML + " <td > " + "Female" + "</td>";
            strHTML = strHTML + " <td > " + arrFU[0].ToString() + "</td>";
            strHTML = strHTML + " <td > " + arrFU[1].ToString() + " </td>";

            strHTML = strHTML + " <tr><td >" + 4 + "</td>";
            strHTML = strHTML + " <td > " + "Rural" + "</td>";
            strHTML = strHTML + " <td > " + "Female" + "</td>";
            strHTML = strHTML + " <td > " + arrFR[0].ToString() + "</td>";
            strHTML = strHTML + " <td > " + arrFR[1].ToString() + " </td>";

            strHTML = strHTML + " <tr><td >" + 5 + "</td>";
            strHTML = strHTML + " <td > " + "Urban" + "</td>";
            strHTML = strHTML + " <td > " + "Other" + "</td>";
            strHTML = strHTML + " <td > " + arrOU[0].ToString() + "</td>";
            strHTML = strHTML + " <td > " + arrOU[1].ToString() + " </td>";

            strHTML = strHTML + " <tr><td >" + 6 + "</td>";
            strHTML = strHTML + " <td > " + "Rural" + "</td>";
            strHTML = strHTML + " <td > " + "Other" + "</td>";
            strHTML = strHTML + " <td > " + arrOR[0].ToString() + "</td>";
            strHTML = strHTML + " <td > " + arrOR[1].ToString() + " </td>";
    ...
    protected void btnUtilityTransaction_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            // strSql = " SELECT 'UBP' SERVICE, AREA, CLINT_GENDER, SUM(TOTAL_TRANSACTION) TOTAL_TRANSACTION, SUM(AMOUNT) TRANSACTION_AMOUNT FROM (SELECT COUNT(*) TOTAL_TRANSACTION,SUM (TOTAL_BILL_AMOUNT) AMOUNT,'Urban' AREA, CL.CLINT_GENDER FROM UTILITY_TRANSACTION UT, ACCOUNT_LIST AL, CLIENT_LIST CL, MANAGE_THANA MT WHERE SERVICE IN ('UBP', 'UBPW', 'UWZP','UBPKG','UBPDSP') AND REQUEST_ID IS NOT NULL AND RESPONSE_STATUS_BP = '000' AND AL.CLINT_ID = CL.CLINT_ID AND CL.THANA_ID = MT.THANA_ID AND TRUNC (TRANSA_DATE) BETWEEN '" + dtpUtFrom.DateString + "' AND '" + dtpUtTo.DateString + "' AND MT.THANA_NAME LIKE ('%Sadar%') AND UT.SOURCE_ACC_NO = AL.ACCNT_NO AND AL.ACCNT_RANK_ID IN ('120519000000000005', '120519000000000006','120519000000000005', '120519000000000006','161215000000000004','180128000000000008') GROUP BY CL.CLINT_GENDER UNION ALL SELECT COUNT(*) TOTAL_TRANSACTION,SUM (TOTAL_BILL_AMOUNT) AMOUNT,'Rural' AREA, CL.CLINT_GENDER FROM UTILITY_TRANSACTION UT, ACCOUNT_LIST AL, CLIENT_LIST CL, MANAGE_THANA MT WHERE SERVICE IN ('UBP', 'UBPW', 'UWZP','UBPKG','UBPDSP') AND REQUEST_ID IS NOT NULL AND RESPONSE_STATUS_BP = '000' AND AL.CLINT_ID = CL.CLINT_ID AND CL.THANA_ID = MT.THANA_ID AND TRUNC (TRANSA_DATE) BETWEEN '" + dtpUtFrom.DateString + "' AND '" + dtpUtTo.DateString + "' AND MT.THANA_NAME NOT LIKE ('%Sadar%') AND UT.SOURCE_ACC_NO = AL.ACCNT_NO AND AL.ACCNT_RANK_ID IN ('120519000000000005', '120519000000000006','120519000000000005', '120519000000000006','161215000000000004','180128000000000008') GROUP BY CL.CLINT_GENDER UNION ALL SELECT COUNT(*) TOTAL_TRANSACTION,SUM (BILL_AMOUNT) AMOUNT,'Urban' AREA, CL.CLINT_GENDER FROM DPDC_PREPAID_BILL_COL_DETAIL DL, ACCOUNT_LIST AL, CLIENT_LIST CL, MANAGE_THANA MT WHERE EXECUTE_STATUS = 'Success' AND DL.AGENT_ACCNT_NO = AL.ACCNT_NO AND AL.CLINT_ID = CL.CLINT_ID AND CL.THANA_ID = MT.THANA_ID AND TRUNC (EXECUTE_DATE) BETWEEN '" + dtpUtFrom.DateString + "' AND '" + dtpUtTo.DateString + "' AND MT.THANA_NAME LIKE ('%Sadar%') GROUP BY CL.CLINT_GENDER UNION ALL SELECT COUNT(*) TOTAL_TRANSACTION,SUM (BILL_AMOUNT) AMOUNT,'Rural' AREA, CL.CLINT_GENDER FROM DPDC_PREPAID_BILL_COL_DETAIL DL, ACCOUNT_LIST AL, CLIENT_LIST CL, MANAGE_THANA MT WHERE EXECUTE_STATUS = 'Success' AND DL.AGENT_ACCNT_NO = AL.ACCNT_NO AND AL.CLINT_ID = CL.CLINT_ID AND CL.THANA_ID = MT.THANA_ID AND TRUNC (EXECUTE_DATE) BETWEEN '" + dtpUtFrom.DateString + "' AND '" + dtpUtTo.DateString + "' AND MT.THANA_NAME NOT LIKE ('%Sadar%') GROUP BY CL.CLINT_GENDER) GROUP BY AREA, CLINT_GENDER ";
            string MU = objServiceHandler.getBBankUtilityReportData(dtpUtFrom.DateString, dtpUtTo.DateString, " LIKE " + "'%Sadar%' ", "'M'");
            string MR = objServiceHandler.getBBankUtilityReportData(dtpUtFrom.DateString, dtpUtTo.DateString, " NOT LIKE " + "'%Sadar%' ", "'M' ");
            string FU = objServiceHandler.getBBankUtilityReportData(dtpUtFrom.DateString, dtpUtTo.DateString, " LIKE " + "'%Sadar%' ", "'F' ");
            string FR = objServiceHandler.getBBankUtilityReportData(dtpUtFrom.DateString, dtpUtTo.DateString, " NOT LIKE " + "'%Sadar%' ", "'F' ");
            string OTU = objServiceHandler.getBBankUtilityReportData(dtpUtFrom.DateString, dtpUtTo.DateString, " LIKE " + "'%Sadar%' ", "'O' ");
            string OTR = objServiceHandler.getBBankUtilityReportData(dtpUtFrom.DateString, dtpUtTo.DateString, " NOT LIKE " + "'%Sadar%' ", "'O' ");
            string[] arrMU = MU.Split('*');
            string[] arrMR = MR.Split('*');
            string[] arrFU = FU.Split('*');
            string[] arrFR = FR.Split('*');
    ...
    protected void btnMaxis_Click(object sender, EventArgs e)
    {
        try
        {
            string strSql = "";
            ...
            {
                strSql = " SELECT * FROM (SELECT REQUEST_ID,CAL.CAS_ACC_NO SEN_NO,GET_ACCNT_NAME(CAL.CAS_ACC_NO) SEN_NAME FROM BDMIT_ERP_101.CAS_ACCOUNT_TRANSACTION CAT,BDMIT_ERP_101.CAS_ACCOUNT_TYPE CAAT,BDMIT_ERP_101.CAS_ACCOUNT_LIST CAL WHERE CAAT.CAS_ACC_TYPE_ID='20081301002005' AND CAL.CAS_ACC_ID=CAT.CAS_ACC_ID AND CAL.CAS_ACC_TYPE_ID=CAAT.CAS_ACC_TYPE_ID AND CAT.CAS_TRAN_TYPE='D') T1,(SELECT REQUEST_ID,CAL.CAS_ACC_NO REC_NO,GET_ACCNT_NAME(CAL.CAS_ACC_NO) REC_NAME,ACCESS_CODE,CAT.CAS_TRAN_AMT,CAT.CAS_TRAN_DATE FROM BDMIT_ERP_101.CAS_ACCOUNT_TRANSACTION CAT ,BDMIT_ERP_101.CAS_ACCOUNT_TYPE CAAT,BDMIT_ERP_101.CAS_ACCOUNT_LIST CAL WHERE CAAT.CAS_ACC_TYPE_ID='20092301002001' AND CAL.CAS_ACC_ID=CAT.CAS_ACC_ID AND CAL.CAS_ACC_TYPE_ID=CAAT.CAS_ACC_TYPE_ID AND CAT.CAS_TRAN_TYPE='C') T2 WHERE T1.REQUEST_ID=T2.REQUEST_ID AND T2.CAS_TRAN_DATE  BETWEEN '" + dtpMaxisFrom.DateString + "' AND '" + dtpMaxisTo.DateString + "' ORDER BY  CAS_TRAN_DATE";
            }
            else
            {
                strSql = " SELECT * FROM (SELECT REQUEST_ID,CAL.CAS_ACC_NO SEN_NO,GET_ACCNT_NAME(CAL.CAS_ACC_NO) SEN_NAME FROM BDMIT_ERP_101.CAS_ACCOUNT_TRANSACTION CAT,BDMIT_ERP_101.CAS_ACCOUNT_TYPE CAAT,BDMIT_ERP_101.CAS_ACCOUNT_LIST CAL WHERE CAAT.CAS_ACC_TYPE_ID='20081301002003' AND CAL.CAS_ACC_ID=CAT.CAS_ACC_ID AND CAL.CAS_ACC_TYPE_ID=CAAT.CAS_ACC_TYPE_ID AND CAT.CAS_TRAN_TYPE='D') T1,(SELECT REQUEST_ID,CAL.CAS_ACC_NO REC_NO,GET_ACCNT_NAME(CAL.CAS_ACC_NO) REC_NAME,ACCESS_CODE,CAT.CAS_TRAN_AMT,CAT.CAS_TRAN_DATE FROM BDMIT_ERP_101.CAS_ACCOUNT_TRANSACTION CAT ,BDMIT_ERP_101.CAS_ACCOUNT_TYPE CAAT,BDMIT_ERP_101.CAS_ACCOUNT_LIST CAL WHERE CAAT.CAS_ACC_TYPE_ID='20081301002005' AND CAL.CAS_ACC_ID=CAT.CAS_ACC_ID AND CAL.CAS_ACC_TYPE_ID=CAAT.CAS_ACC_TYPE_ID AND CAT.CAS_TRAN_TYPE='C') T2 WHERE T1.REQUEST_ID=T2.REQUEST_ID AND T2.CAS_TRAN_DATE  BETWEEN '" + dtpMaxisFrom.DateString + "' AND '" + dtpMaxisTo.DateString + "' ORDER BY  CAS_TRAN_DATE";
            }
            if (chkMM.Checked == true)
            {

                fileName = "MAXIS_MERCHANT_Report";
                strTitle = "MAXIS MERCHANT Report";
            }
            else
            {
                fileName = "MAXIS_DSE_Report";
                strTitle = "MAXIS DSE Report";
            }
            ...
            strHTML = strHTML + "</table>";
            strHTML = strHTML + "<table border=\"0\" width=\"100%\">";
            strHTML = strHTML + "<tr><td COLSPAN=11 align=center style='border-right:none;font-size:14px;font-weight:bold;'><h4 align=center>Date Range: '" + dtpMaxisFrom.DateString + "' To '" + dtpMaxisTo.DateString + "'</h2></td></tr>";
            strHTML = strHTML + "</table>";
            strHTML = strHTML + "<table border=\"1\" width=\"100%\">";
            strHTML = strHTML + "<tr>";

            strHTML = strHTML + "<td valign='middle' >Sl</td>";
            strHTML = strHTML + "<td valign='middle' >TRX TIME</td>";
            strHTML = strHTML + "<td valign='middle' >SENDER WALLET ID</td>";
            strHTML = strHTML + "<td valign='middle' >SENDER WALLET NAME</td>";
            strHTML = strHTML + "<td valign='middle' >RECIEVER WALLET ID</td>";
            strHTML = strHTML + "<td valign='middle' >RECIEVER WALLET NAME</td>";
            strHTML = strHTML + "<td valign='middle' >ACCESS CODE</td>";
            ...
            if (dtsAccount.Tables[0].Rows.Count > 0)
            {
                ...
                foreach (DataRow prow in dtsAccount.Tables[0].Rows)
                {
                    ...
                    strHTML = strHTML + " <td > '" + prow["SEN_NO"].ToString() + "</td>";
                    strHTML = strHTML + " <td > '" + prow["SEN_NAME"].ToString() + "</td>";
                    strHTML = strHTML + " <td > '" + prow["REC_NO"].ToString() + "</td>";
                    strHTML = strHTML + " <td > '" + prow["REC_NAME"].ToString() + " </td>";
                    strHTML = strHTML + " <td > '" + prow["ACCESS_CODE"].ToString() + " </td>";
                    strHTML = strHTML + " <td > '" + prow["CAS_TRAN_AMT"].ToString() + " </td>";

                    strHTML = strHTML + " </tr> ";
                    SerialNo = SerialNo + 1;
                    totalAmount = totalAmount + Convert.ToDouble(prow["CAS_TRAN_AMT"].ToString());
                }
            }
