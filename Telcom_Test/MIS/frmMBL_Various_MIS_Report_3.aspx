    ...
    <div>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="ddlBillType">
												...
												<asp:ListItem Value="BREB">BREB</asp:ListItem>                                                <asp:ListItem Value="NESCO">NESCO</asp:ListItem>
                                            </asp:DropDownList>
					...
					<tr>
                        <td>
                           ...
                           <%-- Added by chamak on 12/09/2021--%>
                            <fieldset style="width: 550px">
                                <legend><strong>Provita Report (Details)</strong></legend>
                                <table style="width: 550px">
                                    <tr>
                                        <td><strong>From Date</strong> </td>
                                        <td>
                                            <cc1:GMDatePicker ID="fromDateProvita" runat="server" CalendarTheme="Silver" DateFormat="dd-MMM-yyyy" MinDate="1900-01-01" Style="position: relative" TextBoxWidth="100">
                                                <CalendarTitleStyle BackColor="#FFFFC0" />
                                            </cc1:GMDatePicker>
                                        </td>
                                        <td><strong>To Date</strong> </td>
                                        <td>
                                            <cc1:GMDatePicker ID="toDateProvita" runat="server" CalendarTheme="Silver" DateFormat="dd-MMM-yyyy" MinDate="1900-01-01" Style="position: relative" TextBoxWidth="100">
                                                <CalendarTitleStyle BackColor="#FFFFC0" />
                                            </cc1:GMDatePicker>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>
                                            <asp:Button ID="btnProvita" runat="server" OnClick="btnProvita_Click" Text="Show Report" />
                                        </td>
                                        <td></td>
                                        <td></td>
                                    </tr>
                        ...
                        <td>
                            <fieldset style="width: 550px">
                                <legend><strong>Business Collection (PILIL)</strong></legend>
                                <table style="width: 550px">
                                    <tr>
                                        <td>
                                            <strong>From Date</strong>
                                        ...
                                        <td>
                                            <cc1:GMDatePicker ID="PILILDatePicker1" runat="server" CalendarTheme="Silver"
                                                DateFormat="dd-MMM-yyyy" MinDate="1900-01-01" Style="position: relative" TextBoxWidth="100">
                                                <CalendarTitleStyle BackColor="#FFFFC0" />
                                            </cc1:GMDatePicker>
                                        </td>
                                        ...
                                        <td>
                                            <cc1:GMDatePicker ID="PILILDatePicker2" runat="server" CalendarTheme="Silver"
                                                DateFormat="dd-MMM-yyyy" MinDate="1900-01-01" Style="position: relative" TextBoxWidth="100">
                                                <CalendarTitleStyle BackColor="#FFFFC0" />
                                            </cc1:GMDatePicker>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="ButtonPILIL" runat="server" Text="Show Report" OnClick="btnPILILiReport_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
                            ...
                            <td>
                            <fieldset style="width: 550px">
                                <legend><strong>Business Collection (Partex Cables)</strong></legend>
                                <table style="width: 550px">
                                    <tr>
                                        <td>
                                            <strong>From Date</strong>
                                        ...
                                        <td>
                                            <cc1:GMDatePicker ID="prCableGMDatePicker1" runat="server" CalendarTheme="Silver"
                                                DateFormat="dd-MMM-yyyy" MinDate="1900-01-01" Style="position: relative" TextBoxWidth="100">
                                                <CalendarTitleStyle BackColor="#FFFFC0" />
                                            </cc1:GMDatePicker>
                                        </td>
                                        ...
                                        <td>
                                            <cc1:GMDatePicker ID="prCableGMDatePicker2" runat="server" CalendarTheme="Silver"
                                                DateFormat="dd-MMM-yyyy" MinDate="1900-01-01" Style="position: relative" TextBoxWidth="100">
                                                <CalendarTitleStyle BackColor="#FFFFC0" />
                                            </cc1:GMDatePicker>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="btnPartexCableReport" runat="server" Text="Show Report" OnClick="btnPartexCableReport_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
                        ...
                        <tr>
                            ...
                            <td>
                            <fieldset style="width: 550px">
                                <legend><strong>Business Collection (Partex Furniture)</strong></legend>
                                <table style="width: 550px">
                                    <tr>
                                        <td>
                                            <strong>From Date</strong>
                                        ...
                                        <td>
                                            <cc1:GMDatePicker ID="prFurGMDatePicker1" runat="server" CalendarTheme="Silver"
                                                DateFormat="dd-MMM-yyyy" MinDate="1900-01-01" Style="position: relative" TextBoxWidth="100">
                                                <CalendarTitleStyle BackColor="#FFFFC0" />
                                            </cc1:GMDatePicker>
                                        </td>
                                        ...
                                        <td>
                                            <cc1:GMDatePicker ID="prFurGMDatePicker2" runat="server" CalendarTheme="Silver"
                                                DateFormat="dd-MMM-yyyy" MinDate="1900-01-01" Style="position: relative" TextBoxWidth="100">
                                                <CalendarTitleStyle BackColor="#FFFFC0" />
                                            </cc1:GMDatePicker>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="btnPartexFurnitureReport" runat="server" Text="Show Report" OnClick="btnPartexFurnitureReport_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
                            ...
                            <td>
                                <fieldset style="width: 550px">
                                <legend><strong>Business Collection Report (RLIL)</strong></legend>
                                <table style="width: 550px">
                                    <tr>
                                        <td>
                                            <strong>From Date</strong>
                                        ...
                                        <td>
                                            <cc1:GMDatePicker ID="GMDatePicker1" runat="server" CalendarTheme="Silver"
                                                DateFormat="dd-MMM-yyyy" MinDate="1900-01-01" Style="position: relative" TextBoxWidth="100">
                                                <CalendarTitleStyle BackColor="#FFFFC0" />
                                            </cc1:GMDatePicker>
                                        </td>
                                        ...
                                        <td>
                                            <cc1:GMDatePicker ID="GMDatePicker2" runat="server" CalendarTheme="Silver"
                                                DateFormat="dd-MMM-yyyy" MinDate="1900-01-01" Style="position: relative" TextBoxWidth="100">
                                                <CalendarTitleStyle BackColor="#FFFFC0" />
                                            </cc1:GMDatePicker>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="btnBCRLI" runat="server" Text="Show Report" OnClick="btnBCRliReport_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
                        ...
                        <tr>
                             <td>
                                <fieldset style="width: 550px">
                                <legend><strong>Business Collection Report (PRAN)</strong></legend>
                                <table style="width: 550px">
                                    <tr>
                                        <td>
                                            <strong>From Date</strong>
                                        ...
                                        <td>
                                            <cc1:GMDatePicker ID="dtPranFrom" runat="server" CalendarTheme="Silver"
                                                DateFormat="dd-MMM-yyyy" MinDate="1900-01-01" Style="position: relative" TextBoxWidth="100">
                                                <CalendarTitleStyle BackColor="#FFFFC0" />
                                            </cc1:GMDatePicker>
                                        </td>
                                        ...
                                        <td>
                                            <cc1:GMDatePicker ID="dtPranTo" runat="server" CalendarTheme="Silver"
                                                DateFormat="dd-MMM-yyyy" MinDate="1900-01-01" Style="position: relative" TextBoxWidth="100">
                                                <CalendarTitleStyle BackColor="#FFFFC0" />
                                            </cc1:GMDatePicker>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="btnBCPran" runat="server" Text="Show Report" OnClick="btnBCPranReport_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
            ...
            <Triggers>
                ...
                <asp:PostBackTrigger ControlID="btnProvita" />
                <asp:PostBackTrigger ControlID="ButtonPILIL" />
                <asp:PostBackTrigger ControlID="btnPartexCableReport" />
                <asp:PostBackTrigger ControlID="btnPartexFurnitureReport" />
                <asp:PostBackTrigger ControlID="btnBCRLI" />
                <asp:PostBackTrigger ControlID="btnBCPran" />
