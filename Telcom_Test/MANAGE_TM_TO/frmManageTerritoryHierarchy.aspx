<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmManageTerritoryHierarchy.aspx.cs" Inherits="MANAGE_TM_TO_frmManageTerritoryHierarchy" %>
...
<head runat="server">
    <title>Define Territory Account Hierarchy</title>
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="Panel1" runat="server" >
           <table width="100%" class="Top_Panel">
              <tr>
                <td> <strong>Define Territory Hierarchy </strong> </td>
                <td>
                </td>
                <td>
                </td>
