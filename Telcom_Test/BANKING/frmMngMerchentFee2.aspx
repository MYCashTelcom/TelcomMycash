<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMngMerchentFee2.aspx.cs" Inherits="BANKING_frmMngMerchentFee2" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
           ...
           Bank  List    
            <asp:DropDownList ID="ddlBankList" runat="server" AutoPostBack="true"></asp:DropDownList>
                            ...
                            <td align="left">
                                 <asp:Label ID="Label3" runat="server" Text="Service List"></asp:Label>
            <asp:DropDownList ID="ddlService" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlService_SelectedIndexChanged">
                        ...
                        <tr>
                             ...
                             <td align="left">
                                <asp:Label ID="Label2" runat="server" Text="Source Rank"></asp:Label>

                                <asp:DropDownList ID="ddlSourceAccountRank" runat="server" AutoPostBack="true"
                                    OnSelectedIndexChanged="ddlSourceAccountRank_SelectedIndexChanged">
                                    <asp:ListItem Value="" Text=""></asp:ListItem>
                                </asp:DropDownList>

                              </td>  
                            <td align="left">
                                <asp:Label ID="lblRank" runat="server" Text="Destination Rank"></asp:Label>
