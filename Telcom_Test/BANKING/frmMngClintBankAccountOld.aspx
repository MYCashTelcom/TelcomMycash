<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMngClintBankAccountOld.aspx.cs"
    Inherits="Forms_frmMngClintBankAccOld" Title="Manage Client bank Account" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div style="background-color: royalblue">
                <strong><span style="color: white">Client Bank Account</span></strong>&nbsp;<asp:Label 
            ...
            <div>
                ...
                <asp:SqlDataSource ID="sdsCliBankAcc" runat="server" DeleteCommand='DELETE FROM "CLIENT_BANK_ACCOUNT" WHERE "CLINT_BANK_ACC_ID" = :CLINT_BANK_ACC_ID'
                    ...
                    SelectCommand='SELECT * FROM "CLIENT_BANK_ACCOUNT" ORDER BY CLINT_BANK_ACC_ID DESC'>
                    <DeleteParameters>
...
FROM ACCOUNT_LIST AL, CLIENT_LIST CL WHERE AL.CLINT_ID = CL.CLINT_ID"></asp:SqlDataSource>
...
FROM ACCOUNT_LIST AL, CLIENT_LIST CL WHERE AL.CLINT_ID = CL.CLINT_ID AND (&quot;CLINT_ID&quot; = :CLINT_ID)">
                ...
                <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                    BorderColor="White" DataKeyNames="CLINT_BANK_ACC_ID" DataSourceID="sdsCliBankAcc"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField SortExpression="ACCNT_ID" HeaderText="Client Account">
                            <EditItemTemplate>
                        ...
                        <asp:TemplateField SortExpression="BANK_ID" HeaderText="Bank">
                            <EditItemTemplate>
            ...
            <div>
                <table>
                <tr><td align="right"><asp:Label ID="Label4" runat="server" Text="Client Account"></asp:Label>  </td><td>
                ...
                <tr><td align="right"><asp:Label ID="Label5" runat="server" Text="Bank"></asp:Label>  </td><td>
