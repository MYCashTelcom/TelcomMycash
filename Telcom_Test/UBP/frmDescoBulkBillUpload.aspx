<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDescoBulkBillUpload.aspx.cs" Inherits="UBP_frmDescoBulkBillUpload" %>
...
<body>
    ...
    <contenttemplate>
        <div class="row" style="background-color: royalblue">
            <table style="width:100%">
                <tr style="width:100%">
                  <td style="width:10%">
                        <strong><span style="color: white">Desco Bulk Bill Upload</span></strong>
                    </td>
                    <td style="width:1%">
    ...
    <div class="row" style="padding-left: 30px;">
        ...
        <br />  
        <br />
        <asp:GridView ID="gdscoBulkBillUp" runat="server"   OnPageIndexChanging="Gridpaging" OnSorting="Gridsorting" GridLines="Both"              CellPadding="6"
                    AutoGenerateColumns="false" 
                    AllowPaging="true"  PageSize="8" AllowSorting="true"
                    OnRowDeleting="gdscoBulkBillUp_RowDeleting"
                    OnRowEditing="gdscoBulkBillUp_RowEditing"
                    OnRowUpdating="gdscoBulkBillUp_RowUpdating"
                    OnRowCancelingEdit="gdscoBulkBillUp_RowCancelingEdit"
