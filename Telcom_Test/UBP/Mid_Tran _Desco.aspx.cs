...
public partial class UBP_Mid_Tran_Desco : System.Web.UI.Page 
{
    ...
    private void LoadGrid()
    {
        ...
        try
        {
            oDataTable = objServiceHandler.GetDetails_Middleware_Desco(Todate, Fromdate, strSearchText, strUsrIdSearchText, strPosSeqrchText, strResSearchText, strMeterId);
    ...
    private void ExportReport(DateTime Todate, DateTime Fromdate)
    {
        ...
        try
        {
            ...
            fileName = "MIDDLEWARE TRANSACTION REPORT FOR DESCO";
            ...
            dtsAccount = objServiceHandler.GetDetails_Middleware_Desco(Todate, Fromdate, strSearchText, strUsrIdSearchText, strPosSeqrchText, strResSearchText, strMeterId);
            ...
            strHTML = strHTML + "<table border=\"0\" width=\"80%\">";
            strHTML = strHTML + "<tr><td COLSPAN=10 align=center style='border-right:none;font-size:14px;font-weight:bold;'><h3 align=center>MIDDLEWARE TRANSACTION REPORT FOR DESCO</h3></td></tr>";
            strHTML = strHTML + "</table>";
            strHTML = strHTML + "<table border=\"0\" width=\"100%\">";
            strHTML = strHTML + "<tr><td COLSPAN=10 align=center style='border-right:none;font-size:14px;font-weight:bold;'><h4 align=center>DESCO REPORT</h2></td></tr>";
            strHTML = strHTML + "</table>";
            strHTML = strHTML + "<table border=\"0\" width=\"100%\">";
            ...
            if (dtsAccount.Rows.Count > 0)
            {
                ...
                foreach (DataRow prow in dtsAccount.Rows)
                {
                    ...
                    strHTML = strHTML + " <td > " + prow["TXN_ID"].ToString() + "</td>";
