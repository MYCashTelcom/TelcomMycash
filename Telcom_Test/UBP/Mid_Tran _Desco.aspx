<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="Mid_Tran _Desco.aspx.cs" Inherits="UBP_Mid_Tran_Desco" %>
...
<div class="row"  style="background-color: royalblue; text-align:left;">
        ...
        <ItemTemplate>
             <%#Container.DataItemIndex+1 %>
                                ...
                                <asp:TemplateField HeaderText="TXN_ID">
                                    <ItemTemplate>
                                        <asp:Label ID="lblTXN_ID" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "TXN_ID") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
