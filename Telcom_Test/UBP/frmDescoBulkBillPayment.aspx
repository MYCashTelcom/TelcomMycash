<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDescoBulkBillPayment.aspx.cs" Inherits="UBP_frmDescoBulkBillPayment" %>
...
<head id="Head1" runat="server">
    <title>Desco Bulk Bill Payment</title>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <asp:Panel ID="pnlGridView" runat="server">
                    <asp:GridView ID="gdcBillPendingList" runat="server" AutoGenerateColumns="False" DataKeyNames="EDOTCO_BILL_PAY_ID"
                        CssClass="mGrid" PageSize="10" AllowPaging="true" Width="80%"
                        EmptyDataText="No data found....."
                        OnPageIndexChanging="gdcBillPendingList_PageIndexChanging">
                        
                        <Columns>
                            <asp:TemplateField HeaderText="EDOTCO_BILL_PAY_ID" Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblEDOTCO_BILL_PAY_ID" Visible="false" runat="server" Text='<%#Bind("EDOTCO_BILL_PAY_ID") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="EDOTCO_BILL_PAY_ID" ControlStyle-Width="100">
                                <ItemTemplate>
                                    <asp:Label ID="lblEDOTCO_BILL_PAY_ID" runat="server" Text='<%#Bind("EDOTCO_BILL_PAY_ID") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="BILL_TYPE" ControlStyle-Width="200">
                                <ItemTemplate>
                                    <asp:Label ID="lblBILL_TYPE" runat="server" Text='<%#Bind("BILL_TYPE") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="gvtxtBillType" runat="server" Text='<%#Bind("BILL_TYPE") %>'></asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="REMARK" ControlStyle-Width="300">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="PURPOSE" ControlStyle-Width="120">
                                <ItemTemplate>
                                    <asp:Label ID="lblUBP_REB_PURPOSE" runat="server" Text='<%#Bind("PURPOSE") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                ...
                <asp:Panel ID="Panel3" runat="server">
                    <asp:GridView ID="gdcPaidBillList" runat="server" AutoGenerateColumns="False" DataKeyNames="UTILITY_TRAN_ID"
                        CssClass="mGrid" PageSize="10" AllowPaging="true" Width="80%"
                        EmptyDataText="No data found....."
                        OnPageIndexChanging="gdcPaidBillList_PageIndexChanging">
                        <Columns>
