...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDescoBulkBillUpload1.aspx.cs" Inherits="UBP_frmDescoBulkBillUpload1" %>
...
<head runat="server">
    <title>Desco Bulk Bill Pay</title>
...
<body>
    ...
    <contenttemplate>
         ...
         <asp:GridView ID="gdvBulkBillPay" runat="server"   OnPageIndexChanging="Gridpaging" OnSorting="Gridsorting" GridLines="Both" CellPadding="6"
                ...
                <Columns>            
                    <asp:TemplateField HeaderText="UBP_REB_BBP_ID" Visible="false">
                        <ItemTemplate>
                            <asp:Label ID="lblAutoID" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "EDOTCO_BILL_PAY_ID") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>            
                            <asp:Label ID="lblEditAutoID" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "EDOTCO_BILL_PAY_ID") %>'></asp:Label>            
                        </EditItemTemplate>
                        <FooterTemplate>
                    ...
                    <asp:TemplateField HeaderText="DESCO Account Id" HeaderStyle-HorizontalAlign="Center"   SortExpression="ACCOUNT_NUMBER"  HeaderStyle-Font-Underline="true" HeaderStyle-BackColor="#A3B6DD" HeaderStyle-Font-Bold="true" HeaderStyle-VerticalAlign="Middle" HeaderStyle-ForeColor="#0A11D5">
                        <ItemTemplate>
                            <asp:Label ID="lblAccountID" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "ACCOUNT_NUMBER") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>            
                            <asp:TextBox ID="txtEditAccountID" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "ACCOUNT_NUMBER") %>'></asp:TextBox>            
                        </EditItemTemplate>                       
                        <FooterTemplate>
                      ...
                      <asp:TemplateField HeaderText="DESCO Account Status"  HeaderStyle-HorizontalAlign="Center" SortExpression="ACCOUNT_STATUS"  HeaderStyle-Font-Underline="true" HeaderStyle-BackColor="#A3B6DD" HeaderStyle-Font-Bold="true" HeaderStyle-VerticalAlign="Middle" HeaderStyle-ForeColor="#0A11D5">
                        <ItemTemplate>
                     ...
                     <asp:TemplateField HeaderText="Remarks"  HeaderStyle-HorizontalAlign="Center"  SortExpression="REMARKS"  HeaderStyle-Font-Underline="true" HeaderStyle-BackColor="#A3B6DD" HeaderStyle-Font-Bold="true" HeaderStyle-VerticalAlign="Middle" HeaderStyle-ForeColor="#0A11D5">
                        <ItemTemplate>
                  ...
                  <asp:TemplateField HeaderText="Purpose"  HeaderStyle-HorizontalAlign="Center"  SortExpression="REMARK"  HeaderStyle-Font-Underline="true" HeaderStyle-BackColor="#A3B6DD" HeaderStyle-Font-Bold="true" HeaderStyle-VerticalAlign="Middle" HeaderStyle-ForeColor="#0A11D5">
                        <ItemTemplate>
        ...
        <div class="row">
            <div class="col-12">                
                       <asp:Label runat="server" Width="8%" Text="DESCO Account ID" style="vertical-align:top;"  Font-Bold="true" ></asp:Label>
                     ...
                     <asp:Label runat="server" ForeColor="Red" Width="20%"   style="vertical-align:top;" Text="*Account ID will be comma seperated (such as: 10000090987871,10000090987872) and Max 100 DESCO Account ID can be saved at a time."></asp:Label>                      
            </div>
        </div>
        <br />
