...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDPDCBulkBillUpload1.aspx.cs" Inherits="UBP_frmDPDCBulkBillUpload1" %>
...
<body>
    ...
    <contenttemplate>
        <!--<div class="row" style="background-color: royalblue">
         ...
         <asp:GridView ID="gdvBulkBillPay" runat="server"   OnPageIndexChanging="Gridpaging" OnSorting="Gridsorting" GridLines="Both" CellPadding="6"
                ...
                <Columns>            
                    ...
                    <asp:TemplateField HeaderText="DPDC Account Id" HeaderStyle-HorizontalAlign="Center"   SortExpression="ACCOUNT_NUMBER"  HeaderStyle-Font-Underline="true" HeaderStyle-BackColor="#A3B6DD" HeaderStyle-Font-Bold="true" HeaderStyle-VerticalAlign="Middle" HeaderStyle-ForeColor="#0A11D5">
                        <ItemTemplate>
                      ...
                      <asp:TemplateField HeaderText="DPDC Account Status"  HeaderStyle-HorizontalAlign="Center" SortExpression="ACCOUNT_STATUS"  HeaderStyle-Font-Underline="true" HeaderStyle-BackColor="#A3B6DD" HeaderStyle-Font-Bold="true" HeaderStyle-VerticalAlign="Middle" HeaderStyle-ForeColor="#0A11D5">
                        <ItemTemplate>
        ...
        <div class="row">
            <div class="col-12">                
                       <asp:Label runat="server" Width="8%" Text="DPDC Account ID" style="vertical-align:top;"  Font-Bold="true" ></asp:Label>
                     ...
                     <asp:Label runat="server" ForeColor="Red" Width="20%"   style="vertical-align:top;" Text="*Account ID will be comma seperated (such as: 10000090987871,10000090987872) and Max 100 DPDC Account ID can be saved at a time."></asp:Label>                      
            </div>
        </div>
        <br />
