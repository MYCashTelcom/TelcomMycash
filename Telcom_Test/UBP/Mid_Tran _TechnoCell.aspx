<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Mid_Tran _TechnoCell.aspx.cs" Inherits="UBP_Mid_Tran__TechnoCell" %>
       ...
       <tr>
        <td class="auto-style15">
           ...
           <td>
            ...
            <asp:ListItem Value="Transaction success">Success</asp:ListItem>                  
            <asp:ListItem Value="Transaction failed">Failed</asp:ListItem>
...
<div class="row"  style="background-color: royalblue; text-align:left;">
        ...
        <ItemTemplate>
             <%#Container.DataItemIndex+1 %>
                                ...
                                <asp:TemplateField HeaderText="TECHNOCELL USER ID">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="RESPONSE TIME">
                                    <ItemTemplate>
