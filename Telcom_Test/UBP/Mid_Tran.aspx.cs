...
public partial class UBP_Mid_Tran : System.Web.UI.Page 
{
    ...
    private void LoadGrid()
    {
        ...
        try
        {
            oDataTable = objServiceHandler.GetDetails_Middleware(Todate, Fromdate, strSearchText, strUsrIdSearchText, strPosSeqrchText, strResSearchText, strMeterId);
    ...
    private void ExportReport(DateTime Todate, DateTime Fromdate)
    {
        ...
        try
        {
            ...
            dtsAccount = objServiceHandler.GetDetails_Middleware(Todate, Fromdate, strSearchText, strUsrIdSearchText, strPosSeqrchText, strResSearchText, strMeterId);
            ...
            strHTML = strHTML + "<table border=\"0\" width=\"80%\">";
            strHTML = strHTML + "<tr><td COLSPAN=10 align=center style='border-right:none;font-size:14px;font-weight:bold;'><h3 align=center>MIDDLEWARE TRANSACTION REPORT</h3></td></tr>";
            strHTML = strHTML + "</table>";
            ...
            strHTML = strHTML + "<td valign='middle' > DPDC POS ID</td>";
