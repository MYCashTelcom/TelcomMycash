<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDPDC_Pos.aspx.cs" Inherits="frmDPDC_Pos"  %>
...
<body style="background-color: lightgrey;">
    ...
    <contenttemplate>
        ...
        <asp:SqlDataSource id="sdsDPDCPos" runat="server" 
            ...
            InsertCommand="INSERT INTO DPDC_PREPAID_METER_POS_LIST (POS_LIST_ID, AAMRA_USER_ID, DPDC_POS_ID, IS_ACTIVE)
             VALUES (:POS_LIST_ID,:AAMRA_USER_ID, :DPDC_POS_ID, :IS_ACTIVE)" 
            ...
            SelectCommand="SELECT POS_LIST_ID,AAMRA_USER_ID,DPDC_POS_ID,IS_ACTIVE FROM DPDC_PREPAID_METER_POS_LIST ORDER BY AAMRA_USER_ID ASC ">
       <%-- <SelectParameters>
