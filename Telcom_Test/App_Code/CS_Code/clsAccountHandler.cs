...
public class clsAccountHandler
{
   ...
   // private OracleTransaction dbTransaction = null;
    ...
    /********End  New Client bank Acount********/
     ...
     #region #region registration verification

     //add by Abdul Bari 15/9/2022
     ...
     public string UpdateDKYC(string mobileNo)
     {
         ...
         try
         {
             ...
             cmd.CommandText = "UPDATE DIGITAL_KYC_INFO SET IS_UPDATE = 'Y' WHERE CLINT_MOBILE='" + mobileNo.Trim() + "'"; // 
