        ...
        <ext:Panel ID="Panel2" runat="server" Height="350" Header="false" HideBorders="True" BodyStyle="padding:50px 0;" Layout="Center">
            ...
            <Items>
                <ext:Panel runat="server" ID="pnlLogin"
                            ...
                            <Anchors>
                                <ext:Anchor Horizontal="100%">
                                    <ext:TextField runat="server"
                                        ID="txtUsername"
                                        AllowBlank="false"
                                        Width="250" ValidationEvent="^(?=.{8,})(?=.*[a-z])(?=.*[A-Z])(?=.*[@#*!?$%^&amp;+=]).*$"
                                        FieldLabel="Username" 
                    ...
                    <Buttons>
                        <ext:Button ID="btnLogin" runat="server" Text="Login" Enabled="true" Icon="Accept">
                            <Listeners>
                                <Click Handler="
                        ...
                        <%--<ext:Button ID="btnNewReg" runat="server" Visible="true" Text="Registration" Enabled="true" Icon="Application">
                            <DirectEvents>
                                <Click OnEvent="btnNewReg_Click">
                                    <EventMask ShowMask="true" Msg="Login..." MinDelay="500" />
                                </Click>
                            </DirectEvents>
                        </ext:Button>--%>
