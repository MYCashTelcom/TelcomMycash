    ...
    private void ExportReport()
    {
        ...
        try
        {
            ...
            if (dtsAccount.Rows.Count > 0)
            {
                ...
                {
                    if (prow["SYSTEM_NOTE"].ToString().Contains("This Bill Already Paid:"))
                    {
                        ...
                        strHTML = strHTML + " <td > '" + paid + "</td>";
                        strHTML = strHTML + " <td > '" + paid + "</td>";
                        strHTML = strHTML + " <td > '" + "Paid By MYcash" + "</td>";
                    ...
                    else
                    {
                        if (prow["CHEQUE_REMARKS"].ToString() != "")
                        {
                            ...
                            string lpcDate = sList[8].Trim().Replace("LPC_DATE:", "");
                            ...
                            strHTML = strHTML + " <td > '" + (lpcDate == "null" ? noDataFound : dueLpcAmt) + "</td>";
