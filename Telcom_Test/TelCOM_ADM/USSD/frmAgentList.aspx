<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmAgentList.aspx.cs" Inherits="USSD_frmAgentList" %>
...
<body style="background-color: lightgrey;">
    ...
    <ContentTemplate>
     ...
     <asp:DropDownList ID="ddlAgentType" runat="server">
         <asp:ListItem Value="0">Agent List</asp:ListItem>
         <asp:ListItem Value="1">Agent List (Value)</asp:ListItem>
     </asp:DropDownList>
     <br />
     Report Type&nbsp; :   
