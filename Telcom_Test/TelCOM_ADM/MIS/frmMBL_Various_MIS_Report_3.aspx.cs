        ...
        try
        {
            ...
            else if (drpType.SelectedValue == "1")
            {
                strSql = " SELECT DISTINCT UT.UTILITY_TRAN_ID, SR.REQUEST_ID, UT.ACCOUNT_NUMBER, UT.BILL_NUMBER, UT.LOCATION_ID, "
                        ...
                        + " UT.RESPONSE_MSG_BP FROM APSNG101.UTILITY_TRANSACTION UT, APSNG101.SERVICE_REQUEST SR, "
                        + " BDMIT_ERP_101.VW_CAS_ACCOUNT_TRANSACTION CAT  WHERE UT.STAKEHOLDER_ID = 'MBLBANK' AND UT.SERVICE = 'UBP' "
                        + " AND UT.REVERSE_STATUS = 'R' AND SR.SMSC_REFERENCE_NO = UT.REQUEST_ID AND SR.REQUEST_ID = CAT.REQUEST_ID "
                        + " AND CAT.CAS_TRAN_STATUS = 'R' AND TRUNC(UT.TRANSA_DATE) BETWEEN '" + dtpBpVarFDate.DateString + "' AND '" + dtpBpVarToDate.DateString + "' "
            ...
            else if (drpType.SelectedValue == "2")
            {
                strSql = " SELECT DISTINCT UT.UTILITY_TRAN_ID, SR.REQUEST_ID, UT.ACCOUNT_NUMBER, UT.BILL_NUMBER, UT.LOCATION_ID, UT.OWNER_CODE, "
                        ...
                        + " FROM APSNG101.UTILITY_TRANSACTION UT, APSNG101.SERVICE_REQUEST SR, BDMIT_ERP_101.VW_CAS_ACCOUNT_TRANSACTION CAT "
                        + " WHERE UT.STAKEHOLDER_ID = 'MBLBANK' AND UT.SERVICE = 'UBP' AND UT.REVERSE_STATUS = 'R' AND SR.SMSC_REFERENCE_NO = UT.REQUEST_ID "
                        + " AND SR.REQUEST_ID = CAT.REQUEST_ID AND CAT.CAS_TRAN_STATUS = 'R' AND TRUNC(UT.TRANSA_DATE) BETWEEN '" + dtpBpVarFDate.DateString + "' AND '" + dtpBpVarToDate.DateString + "' "
            ...
            else if (drpType.SelectedValue == "3")
            {
                strSql = " SELECT   DISTINCT UT.UTILITY_TRAN_ID, SR.REQUEST_ID, UT.ACCOUNT_NUMBER, UT.BILL_NUMBER, UT.LOCATION_ID, UT.OWNER_CODE, "
                        ...
                        + " THEN 'AUTO REVERSE' END AS RESPONSE_STATUS_BP_CODE, UT.RESPONSE_MSG_BP FROM   APSNG101.UTILITY_TRANSACTION UT , "
                        ...
                        + " AND SR.REQUEST_ID = CAT.REQUEST_ID AND UT.SERVICE = 'UBP' AND TRUNC (UT.TRANSA_DATE) BETWEEN '" + dtpBpVarFDate.DateString + "' AND '" + dtpBpVarToDate.DateString + "' "
            ...
            else if (drpType.SelectedValue == "4")
            {
                strSql = " SELECT DISTINCT UT.UTILITY_TRAN_ID, SR.REQUEST_ID, UT.ACCOUNT_NUMBER, UT.BILL_NUMBER, UT.LOCATION_ID, UT.OWNER_CODE, "
                        ...
                        + " UT.RESPONSE_MSG_BP FROM APSNG101.UTILITY_TRANSACTION UT, APSNG101.SERVICE_REQUEST SR, BDMIT_ERP_101.VW_CAS_ACCOUNT_TRANSACTION CAT "
                        + " WHERE UT.STAKEHOLDER_ID = 'MBLBANK' AND UT.SERVICE = 'UBP' AND UT.REVERSE_STATUS = 'R' "
                        + " AND SR.SMSC_REFERENCE_NO = UT.REQUEST_ID AND SR.REQUEST_ID = CAT.REQUEST_ID AND CAT.CAS_TRAN_STATUS = 'R' "
                        + " AND TRUNC(UT.TRANSA_DATE) BETWEEN '" + dtpBpVarFDate.DateString + "' AND '" + dtpBpVarToDate.DateString + "' "
