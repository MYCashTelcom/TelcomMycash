     ...
     <asp:ScriptManager ID="ScriptManager1" runat="server">
      ...
      <div style="background-color: lightgrey">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
          <contenttemplate>
            <div>
                <asp:SqlDataSource ID="sdsSysGroup" runat="server" ConnectionString="<%$ ConnectionStrings:oracleConString %>" ProviderName="<%$ ConnectionStrings:oracleConString.ProviderName %>" SelectCommand='SELECT "SYS_USR_GRP_ID", "SYS_USR_GRP_TITLE" FROM "CM_SYSTEM_USER_GROUP"'></asp:SqlDataSource>
                <asp:SqlDataSource ID="sdsSysMenu" runat="server" ConnectionString="<%$ ConnectionStrings:oracleConString %>" ProviderName="<%$ ConnectionStrings:oracleConString.ProviderName %>" SelectCommand='SELECT "SYS_MENU_ID", "SYS_MENU_TITLE" FROM "CM_SYSTEM_MENU" ORDER BY "SYS_MENU_TITLE"'></asp:SqlDataSource>
                <asp:SqlDataSource ID="sdsRemainSysMenu" runat="server" ConnectionString="<%$ ConnectionStrings:oracleConString %>"
                    ProviderName="<%$ ConnectionStrings:oracleConString.ProviderName %>" SelectCommand="SELECT DISTINCT SYS_MENU_ID, SYS_MENU_TITLE,SYS_MENU_SERIAL
FROM CM_SYSTEM_MENU 
WHERE SYS_MENU_ID NOT IN (
SELECT DISTINCT SYS_MENU_ID
FROM CM_SYSTEM_ACCESS_POLICY WHERE SYS_USR_GRP_ID=:SYS_USR_GRP_ID) ORDER BY SYS_MENU_SERIAL">
                    <SelectParameters>
                ...
                <asp:SqlDataSource ID="sdsSysAccessPolicy" runat="server" 
                    ...
                    InsertCommand='INSERT INTO "CM_SYSTEM_ACCESS_POLICY" ("SYS_ACCP_ID", "SYS_USR_GRP_ID", "SYS_MENU_ID", "SYS_ACCP_VIEW", "SYS_ACCP_ADD", "SYS_ACCP_DELETE", "SYS_ACCP_EDIT", "SYS_ACCP_PRINT") VALUES (:SYS_ACCP_ID, :SYS_USR_GRP_ID, :SYS_MENU_ID, :SYS_ACCP_VIEW, :SYS_ACCP_ADD, :SYS_ACCP_DELETE, :SYS_ACCP_EDIT, :SYS_ACCP_PRINT)' 
                    OldValuesParameterFormatString="original_{0}" 
                    ProviderName="<%$ ConnectionStrings:oracleConString.ProviderName %>" 
                    SelectCommand='SELECT SP.SYS_ACCP_ID, SP.SYS_USR_GRP_ID, SP.SYS_MENU_ID, SP.SYS_ACCP_VIEW, SP.SYS_ACCP_ADD, SP.SYS_ACCP_DELETE, SP.SYS_ACCP_EDIT, SP.SYS_ACCP_PRINT 
FROM CM_SYSTEM_ACCESS_POLICY SP,CM_SYSTEM_MENU SM
 WHERE SP.SYS_MENU_ID=SM.SYS_MENU_ID AND (SYS_USR_GRP_ID = :SYS_USR_GRP_ID) ORDER BY SM.SYS_MENU_SERIAL' 
                    UpdateCommand='UPDATE "CM_SYSTEM_ACCESS_POLICY" SET "SYS_USR_GRP_ID" = :SYS_USR_GRP_ID, "SYS_MENU_ID" = :SYS_MENU_ID, "SYS_ACCP_VIEW" = :SYS_ACCP_VIEW, "SYS_ACCP_ADD" = :SYS_ACCP_ADD, "SYS_ACCP_DELETE" = :SYS_ACCP_DELETE, "SYS_ACCP_EDIT" = :SYS_ACCP_EDIT, "SYS_ACCP_PRINT" = :SYS_ACCP_PRINT WHERE "SYS_ACCP_ID" = :original_SYS_ACCP_ID AND (("SYS_USR_GRP_ID" = :original_SYS_USR_GRP_ID) OR ("SYS_USR_GRP_ID" IS NULL AND :original_SYS_USR_GRP_ID IS NULL)) AND (("SYS_MENU_ID" = :original_SYS_MENU_ID) OR ("SYS_MENU_ID" IS NULL AND :original_SYS_MENU_ID IS NULL)) AND (("SYS_ACCP_VIEW" = :original_SYS_ACCP_VIEW) OR ("SYS_ACCP_VIEW" IS NULL AND :original_SYS_ACCP_VIEW IS NULL)) AND (("SYS_ACCP_ADD" = :original_SYS_ACCP_ADD) OR ("SYS_ACCP_ADD" IS NULL AND :original_SYS_ACCP_ADD IS NULL)) AND (("SYS_ACCP_DELETE" = :original_SYS_ACCP_DELETE) OR ("SYS_ACCP_DELETE" IS NULL AND :original_SYS_ACCP_DELETE IS NULL)) AND (("SYS_ACCP_EDIT" = :original_SYS_ACCP_EDIT) OR ("SYS_ACCP_EDIT" IS NULL AND :original_SYS_ACCP_EDIT IS NULL)) AND (("SYS_ACCP_PRINT" = :original_SYS_ACCP_PRINT) OR ("SYS_ACCP_PRINT" IS NULL AND :original_SYS_ACCP_PRINT IS NULL))'>
                    <DeleteParameters>
