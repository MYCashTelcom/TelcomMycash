<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmKYCUpdateV1.aspx.cs" Inherits="COMMON_frmKYCUpdateV1"  %>
                   ...
                   <td class="td">
                    ...
                    <td>
                     ...
                     <td>
                       ...
                       <td>
                           <asp:DropDownList ID="ddlThana" runat="server" DataSourceID="sdsThana" 
                               ...
                               Width="153px">                                                   
                               <%--<asp:ListItem  Value="">Select a Thana</asp:ListItem>--%>
                           </asp:DropDownList>
                           <span style="color:Red;">*</span>
                     ...
                     <tr>
                        ...
                        <td colspan="1">
                         <asp:dropdownlist id="ddlPurOfTran" Width="153px"  runat="server"
                          AppendDataBoundItems="true"   DataTextField="PUR_OF_TRAN" 
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <asp:RequiredFieldValidator ID="rfvPresentAddress" runat="server" 
                                ...
                                ValidationGroup="Update" Display="Dynamic"></asp:RequiredFieldValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="td">
