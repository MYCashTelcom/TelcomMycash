...
public partial class COMMON_frmEduSmartInstituteInfo : System.Web.UI.Page
{
    ...
    protected void btnSaveAmount_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string strAddInstitute = objServiceHandler.AddTestInstitutePayment(strInstituteName, strPurposeName, strPurposeCode, strDescription, strAmount);
