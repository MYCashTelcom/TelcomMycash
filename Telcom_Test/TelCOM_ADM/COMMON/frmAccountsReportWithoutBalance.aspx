<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmAccountsReportWithoutBalance.aspx.cs"
    Inherits="COMMON_frmAccountsReportWithoutBalance" %>
            ...
            <table>
                            ...
                            <tr>
                                <td colspan="2">                                    
                                    <asp:RadioButtonList ID="rbtnSelectRank" runat="server" RepeatDirection="Horizontal"
                                        ...
                                        <asp:ListItem Value="0" Selected="True" Text="MBL Branch"></asp:ListItem>
                                        <asp:ListItem Value="1" Text="MBL Distributor"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="MBL DSE"></asp:ListItem>
                                        <asp:ListItem Value="3" Text="MBL Agent"></asp:ListItem>
                                        <asp:ListItem Value="4" Text="MBL Customer"></asp:ListItem>
                                    </asp:RadioButtonList>
                                    <br />
                ...
                <tr>
                 ...
                 <tr> <td valign="top" class="style2">
                    <fieldset style="border-color: #FFFFFF; width: 524px; height:130px">
                     <legend><strong style="color: #666666">&nbsp;&nbsp;All District Report</strong></legend>
                        <table>
                            <tr>
                                <td style="height: 30px;">
                                    <asp:RadioButtonList ID="rbtnDIstrictListItem" RepeatDirection="Horizontal" AutoPostBack="true"
                                        runat="server" >
                                        <asp:ListItem Selected="True" Value="All">All</asp:ListItem>
                                        <asp:ListItem Value="Date" >Date Range</asp:ListItem>
                                    </asp:RadioButtonList>
                                ...
                                <td>    
                                    <asp:Label ID="ddd" runat="server" Text="From Date :" ></asp:Label>                                   
                                     <cc1:GMDatePicker ID="dptAllFDate" runat="server"  CalendarTheme="Silver" 
                                         DateFormat="dd/MMM/yyyy HH:mm:ss" MinDate="1900-01-01" Style="position: relative;" 
                                         TextBoxWidth="110" Font-Size="X-Small">
                                       <calendartitlestyle backcolor="#FFFFC0"  Font-Size="X-Small" />
                                     </cc1:GMDatePicker>
                                   To Date :
                                    <strong>
                                        <cc1:GMDatePicker ID="dptAllTDate" runat="server" CalendarTheme="Silver" 
                                            DateFormat="dd/MMM/yyyy HH:mm:ss" MinDate="1900-01-01" Style="position: relative" 
                                            TextBoxWidth="110" Font-Size="X-Small">
                                            <calendartitlestyle backcolor="#FFFFC0" Font-Size="X-Small" />
                                        </cc1:GMDatePicker>
                            ...
                            <tr>
                                <td colspan="2">                                    
                                    <asp:RadioButtonList ID="rbtnSelectAllDIs" runat="server" RepeatDirection="Horizontal"
                                        OnSelectedIndexChanged="rbtnSelectAllDIs_SelectedIndexChanged">
                                        <asp:ListItem Value="0" Selected="True" Text="MBL Branch"></asp:ListItem>
                                        <asp:ListItem Value="1" Text="MBL Distributor"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="MBL DSE"></asp:ListItem>
                                        <asp:ListItem Value="3" Text="MBL Agent"></asp:ListItem>
                                    ...
                                    <br />
                                    <asp:Button ID="btnAllDisReport" runat="server" Text="Show Report" OnClick="btnAllDisReport_Click" />
