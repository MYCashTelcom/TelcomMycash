...
<body style="background-color: lightgrey;">
    ...
    <ContentTemplate>
                 ...
                 <asp:SqlDataSource ID="sdsThirdPartyAgntList" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:oracleConString %>" 
                     ProviderName="<%$ ConnectionStrings:oracleConString.ProviderName %>" 
                     SelectCommand=" SELECT * FROM THIRD_PARTY_AGENT_LIST">
                 </asp:SqlDataSource> 
                 ...
                 <asp:SqlDataSource ID="sdsClientIdentificationSetUp" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:oracleConString %>" 
                     ProviderName="<%$ ConnectionStrings:oracleConString.ProviderName %>" 
                     SelectCommand="SELECT * FROM &quot;IDENTIFICATION_SETUP&quot;">
                 </asp:SqlDataSource>    
          ...
          <legend></legend>     
            <table width="815px">
             ...
             <tr>
               ...
               <td>
                   <asp:RadioButtonList ID="rblInComptKYC" runat="server" RepeatDirection="Horizontal" AutoPostBack="true">
                       <asp:ListItem Value="Y">Yes</asp:ListItem>
                       <%--<asp:ListItem Value="N">No</asp:ListItem>--%>
           ...
           <asp:Panel ID="pnlIdenContent" runat="server">           
            ...
            <asp:GridView ID="grdClientIdentification" runat="server" AllowPaging="True" 
               ...
               <asp:Panel ID="pnlPopUpIdenUpdate" runat="server"  style=" display:none;width:300px; height:165px; 
                   background-color:White; border-width:1px; border-color:Silver; border-style:solid; padding:1px;">
                  <div style="height:95px;"><br />&nbsp;<br />&nbsp;
                  Are you sure you want to update?
                     <br />&nbsp;<br />&nbsp;
               ...
               <asp:Panel ID="pnlPopUpIdenDelete" runat="server"  style=" display:none;width:300px; height:165px;
                    background-color:White; border-width:1px; border-color:Silver; border-style:solid; padding:1px;">
                  <div style="height:95px;"><br />&nbsp;<br />&nbsp;
                   Are you sure you want to delete?
                     <br />&nbsp;<br />&nbsp;
           ...
           <asp:Panel ID="pnlIntrodDescription" runat="server">
            ...
            <table>
              <tr>
                ...
                <asp:Panel ID="pnlPopUpIntrodUpdate" runat="server"  style=" display:none;width:300px; height:165px; 
                    background-color:White; border-width:1px; border-color:Silver; border-style:solid; padding:1px;">
                  <div style="height:95px;"><br />&nbsp;<br />&nbsp;
                  Are you sure you want to update?
                     <br />&nbsp;<br />&nbsp;
                ...
                <asp:Panel ID="pnlPopUpIntrodDelete" runat="server"  style=" display:none;width:300px; height:165px;
                     background-color:White; border-width:1px; border-color:Silver; border-style:solid; padding:1px;">
                  <div style="height:95px;"><br />&nbsp;<br />&nbsp;
                   Are you sure you want to delete?
                     <br />&nbsp;<br />&nbsp;
             ...
             <tr>
              <td valign="top">
               <asp:GridView ID="grdNomineeInfo" runat="server" AllowPaging="True"  PageSize="3" 
                 ...
                 <asp:Panel ID="pnlPopUpNominiUpdate" runat="server"  style=" display:none;width:300px; height:165px; 
                     background-color:White; border-width:1px; border-color:Silver; border-style:solid; padding:1px;">
                  <div style="height:95px;"><br />&nbsp;<br />&nbsp;
                  Are you sure you want to update?
                     <br />&nbsp;<br />&nbsp;
                ...
                <asp:Panel ID="pnlPopUpNominiDelete" runat="server"  style=" display:none;width:300px; height:165px;
                     background-color:White; border-width:1px; border-color:Silver; border-style:solid; padding:1px;">
                  <div style="height:95px;"><br />&nbsp;<br />&nbsp;
                   Are you sure you want to delete?
                     <br />&nbsp;<br />&nbsp;
