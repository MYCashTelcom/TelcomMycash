<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmQuerySubmitStatus.aspx.cs" Inherits="Forms_frmQuerySubmitStatus" %>
...
<div style="BACKGROUND-COLOR: royalblue"><strong>
 ...
 FROM SERVICE_REQUEST SR LEFT OUTER JOIN SERVICE_RESPONSE RSP ON SR.REQUEST_ID = RSP.REQUEST_ID">
        ...
        <asp:GridView ID="grvRequestList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
            DataKeyNames="REQUEST_ID" DataSourceID="sdsRequestList" CssClass="mGrid" Width="100%" 
