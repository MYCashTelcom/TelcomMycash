<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmQuerySubmitStatusMDetails.aspx.cs" Inherits="Forms_frmQuerySubmitStatusMDetails"%>
      ...
      <div>        
        <asp:GridView ID="grvRequestList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="REQUEST_OTP_AUTHEN" HeaderText="Otp Authen" SortExpression="REQUEST_OTP_AUTHEN" />
                <asp:BoundField DataField="REQUEST_SQA_AUTHEN" HeaderText="SQA Authen" SortExpression="REQUEST_SQA_AUTHEN" />
                <asp:BoundField DataField="REQUEST_OTP_GENERTATED" HeaderText="OTP Gen" SortExpression="REQUEST_OTP_GENERTATED" />
                <asp:BoundField DataField="SYSTEM_NOTE" HeaderText="System Note" SortExpression="SYSTEM_NOTE" />
                
                 <asp:CommandField SelectText="Details" ShowSelectButton="true" ButtonType="Button" Visible="false" />
                </Columns>
