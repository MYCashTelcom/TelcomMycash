<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmIsoRequestStatus.aspx.cs" Inherits="COMMON_frmIsoRequestStatus" %>
     ...
     <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></ajaxToolkit:ToolkitScriptManager>
      <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
           ...
           <br/>
           <asp:Panel runat="server" ID="panel1" CssClass="Top_Panel" Height="55px">
               <table style="width: 100%; ">
                   <tr>
                       <td class="style9" style="width: 110px">
                       ...
                       <td style="width: 150px" class="style11">
                       ...
                       <td class="style3" style="width: 50px">
                       ...
                       <td class="style7" style="width: 170px">
           ...
           <asp:Panel runat="server" ID="panelTitle" CssClass="View_Panel" Visible="False">
