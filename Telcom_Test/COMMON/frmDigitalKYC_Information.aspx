<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDigitalKYC_Information.aspx.cs" Inherits="COMMON_frmDigitalKYC_Information" %>
            ...
            <ContentTemplate>
                <asp:SqlDataSource ID="sdsRequest" runat="server"
                    ...
                    SelectCommand="SELECT SERIAL_NO, DIGITAL_KYC_ID, DKI.CLINT_MOBILE,DKI.CLINT_NAME,DKI.CLINT_FATHER_NAME,DKI.CLINT_MOTHER_NAME,CLIENT_PRE_ADDRESS,REGISTRATION_DATE,
                        AGENT_ACCNT_NO,DKI.IS_UPDATE, DKI.IS_PROCESSING,CL.CLINT_NAME AS CN,CLINT_ADDRESS1, IDENTITY_TYPE, CLINT_NATIONAL_ID,CL.CLINT_GENDER,CL.CUSTOMER_AREA REMARKS
                ...
                <asp:Panel ID="pnlTop" runat="server">
                    <table class="Top_Panel">
                        <tr>
                            ...
                            <td>
                                <asp:Button runat="server" ID="btnSearchNID" Text="Search" OnClick="btnSearchNID_Click" /></td>
                            <td>Mobile:</td>
                            <td>
                            ...
                            <td>Category:<asp:DropDownList runat="server" ID="ddlSearchOption">
                                ...
                                <asp:ListItem Value="nonverified" Selected="True">Pending</asp:ListItem>
       ...
       <asp:Button  ID="btnSearch" runat="server" OnClick="btnSearch_Click" Text="Search" />
        <asp:Button ID="btnExport" runat="server" Text="Export" onclick="btnExport_Click" />
                ...
                <asp:GridView ID="gdvRequest" runat="server" AllowPaging="True"
                    ...
                    OnRowCancelingEdit="gdvRequest_RowCancelingEdit" OnRowDataBound="gdvRequest_RowDataBound"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CUSTOMER_AREA" HeaderText="Customer Area" ItemStyle-Width="85px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                            ReadOnly="True" SortExpression="CUSTOMER_AREA" />
                         <asp:BoundField DataField="CLINT_GENDER" HeaderText="Gender" ItemStyle-Width="85px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                            ReadOnly="True" SortExpression="CLINT_GENDER" />
