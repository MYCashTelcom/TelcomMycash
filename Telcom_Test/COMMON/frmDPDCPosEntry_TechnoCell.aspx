<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDPDCPosEntry_TechnoCell.aspx.cs" Inherits="COMMON_frmDPDCPosEntry_TechnoCell" %>
    ...
    <contenttemplate>
        ...
        <asp:SqlDataSource id="sdsDPDCPos" runat="server" 
            ...
            InsertCommand="INSERT INTO DPDC_PREPAID_METER_POS_LIST (POS_LIST_ID, AAMRA_USER_ID, DPDC_POS_ID, IS_ACTIVE, USER_TYPE)
             VALUES (:POS_LIST_ID,:AAMRA_USER_ID, :DPDC_POS_ID, :IS_ACTIVE, 'TechnoCell')" 
            ...
            SelectCommand="SELECT POS_LIST_ID,AAMRA_USER_ID,DPDC_POS_ID,IS_ACTIVE FROM DPDC_PREPAID_METER_POS_LIST WHERE USER_TYPE='TechnoCell' ORDER BY POS_LIST_ID DESC ">
       <%-- <SelectParameters>
        ...
        <asp:GridView ID="gdvCashAccType" runat="server" Width="900px" 
           ...
           AlternatingRowStyle-CssClass="alt" Font-Size="12px"             
            ...
            <Columns>                
                ...
                <asp:BoundField DataField="AAMRA_USER_ID" HeaderText="TECHNOCELL User ID" 
