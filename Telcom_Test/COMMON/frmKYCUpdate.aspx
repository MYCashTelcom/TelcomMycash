<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmKYCUpdate.aspx.cs" Inherits="COMMON_frmKYCUpdate" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <asp:SqlDataSource ID="sdsNomineeInformation" runat="server"
                    ConnectionString="<%$ ConnectionStrings:oracleConString %>"
                ...
                <asp:SqlDataSource ID="sdsIntroducerInformation" runat="server"
                    ConnectionString="<%$ ConnectionStrings:oracleConString %>"
                ...
                <asp:SqlDataSource ID="sdsRELATIONSHIP" runat="server"
                    ConnectionString="<%$ ConnectionStrings:oracleConString %>"
                    ProviderName="<%$ ConnectionStrings:oracleConString.ProviderName %>"
                    SelectCommand="">
                    <%--SELECT &quot;DISTRICT_ID&quot;, &quot;DISTRICT_NAME&quot; FROM &quot;MANAGE_DISTRICT&quot;--%>
                ...
                <asp:SqlDataSource ID="sdsThirdPartyAgntList" runat="server"
                    ConnectionString="<%$ ConnectionStrings:oracleConString %>"
                    ProviderName="<%$ ConnectionStrings:oracleConString.ProviderName %>"
                    SelectCommand=" SELECT * FROM THIRD_PARTY_AGENT_LIST"></asp:SqlDataSource>
              ...
              <asp:Label ID="Label2" runat="server" Text="Search By Wallet ID:"></asp:Label>
               ...
               <asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click" Width="60px" />
                                <asp:Button ID="btnRefresh" runat="server" OnClick="btnRefresh_Click" Text="New" Width="50px" Visible="false" />
                            </td>
                            <td></td>
                        </tr>
                    </table>
                    ...
                    <fieldset style="border-color: #FFFFFF; width: 815px; height: auto; margin-top: 10px 0px 0px 0px;">
                        ...
                        <table width="815px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:RadioButtonList ID="rblCashIn" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" Enabled="false">
                               ...
                               <td>
                                    <table>
                                        <tr>
                                            <td align="right">
                                                <asp:RadioButtonList ID="rblInComptKYC" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" Height="18px">
                                                    <asp:ListItem Value="Y">Yes</asp:ListItem>
                                                    <%--<asp:ListItem Value="N">No</asp:ListItem>--%>
                                          ...
                                          <td align="left">
                                                <asp:Label ID="lblEKYCStatus" runat="server"  Text=""></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td align="right">Form Serial No:</td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvClientMobile" runat="server"
                                        ControlToValidate="txtClientMobile" ErrorMessage="Please enter mobile no"
                                        ForeColor="Red" ValidationGroup="Update" Display="Dynamic">
                                    </asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="td">Name of the Client: 
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvMotherName" runat="server"
                                        ControlToValidate="txtMothersName" ErrorMessage="Please enter Mother's name"
                                        ValidationGroup="Update" Display="Dynamic">
                                    </asp:RequiredFieldValidator>
                                </td>
                                <td align="right">Father/Husband Name :
                                </td>
                                <td>
                                    <asp:TextBox ID="txtFatherHusbandName" runat="server"></asp:TextBox>
                                    <span style="color: Red;">*</span>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
                                        ControlToValidate="txtFatherHusbandName" ErrorMessage="Please enter Father's/Husband name"
                                        ValidationGroup="Update">
                                    </asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">Client Gender</td>
                                <td>
                                    <asp:RadioButtonList ID="rdoClientGender" runat="server" AutoPostBack="true" RepeatDirection="Horizontal">
                                ...
                                <td>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Select Client Gender"
                                        ControlToValidate="rdoClientGender" ValidationGroup="Update" Display="Dynamic">
                                    </asp:RequiredFieldValidator>
                                </td>
                                <td></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlDistrict" runat="server" Width="153px"
                                        DataSourceID="sdsDistrict" AutoPostBack="true"
                                        AppendDataBoundItems="true" DataTextField="DISTRICT_NAME"
                                        DataValueField="DISTRICT_ID"
                                        OnSelectedIndexChanged="ddlDistrict_SelectedIndexChanged">
                                    </asp:DropDownList>
                                    <span style="color: Red;">*</span>
                                </td>
                                <td align="right">&nbsp;Thana:
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlThana" runat="server" DataSourceID="sdsThana"
                                        AppendDataBoundItems="true"
                                        DataTextField="THANA_NAME" DataValueField="THANA_ID"
                                        Width="153px">
                                    </asp:DropDownList>
                                    <span style="color: Red;">*</span>
                                    <asp:RequiredFieldValidator ID="rfvThana" runat="server"
                                        ControlToValidate="ddlThana" ErrorMessage="Please select a thana"
                                        ValidationGroup="Update" Display="Dynamic">
                                    </asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="td">Purpose of Transction: 
                                </td>

                                <td colspan="1">
                                    <asp:DropDownList ID="ddlPurOfTran" Width="153px" runat="server" AppendDataBoundItems="true"
                                        DataTextField="PUR_OF_TRAN"
                                        DataValueField="PUR_OF_TRAN" SelectedValue='<%# Eval("PUR_OF_TRAN") %>'>
                            ...
                            <tr>
                                <td class="td">Present Address:
                                </td>
                                <td colspan="3">
                                    <asp:TextBox ID="txtPreAddress" Width="502px" TextMode="MultiLine" runat="Server" />
                                    <span style="color: Red;">*</span>
                                    <asp:RequiredFieldValidator ID="rfvPresentAddress" runat="server"
                                        ControlToValidate="txtPreAddress" ErrorMessage="Please enter present address"
                                        ValidationGroup="Update" Display="Dynamic">
                                    </asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td class="td">Permanent Adddress: 
                                </td>
                                ...
                                <td colspan="3">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvPermanentAddress" runat="server"
                                        ControlToValidate="txtPerAddress" ErrorMessage="Please enter permanent address"
                                        ValidationGroup="Update">
                                    </asp:RequiredFieldValidator>
                                </td>
                            </tr>
                        ...
                        <asp:Panel ID="pnlBankHeading" runat="server" CssClass="Inser_Panel">
                            <table class="div" style="height: 20px; width: 812px; cursor: pointer; margin: 2px;">
                                <tr>
                                    ...
                                    <td align="right">
                                        <asp:ImageButton ID="imbBank" runat="server" ImageUrl="~/resources/images/expand.jpg" AlternateText="BankInfo" />
                                    </td>
                                </tr>
                            </table>
                        </asp:Panel>
                                ...
                                <tr>
                                    <td>
                                        <asp:GridView ID="grdBankAccount" runat="server" AllowPaging="True"
                                            PageSize="3" Width="812px" AllowSorting="True" AutoGenerateColumns="False"
                                            DataSourceID="sdsBankAccount" HeaderStyle-Font-Bold="false" DataKeyNames="BANK_ACCNT_ID"
                                            BorderColor="White" CssClass="mGrid" PagerStyle-CssClass="pgr"
                                            AlternatingRowStyle-CssClass="alt"
                                            OnRowCancelingEdit="grdBankAccount_RowCancelingEdit"
                                            OnRowEditing="grdBankAccount_RowEditing"
                                            OnRowUpdated="grdBankAccount_RowUpdated"
                                            OnPageIndexChanged="grdBankAccount_PageIndexChanged"
                                            OnRowDeleted="grdBankAccount_RowDeleted"
                                            OnRowDeleting="grdBankAccount_RowDeleting">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="REMARKS" HeaderText="Remarks"
                                                    SortExpression="REMARKS" ItemStyle-Width="50px">
                      ...
                      Are you sure you want to update?
                       ...
                       Are you sure you want to delete?
                                    ...
                                    <td>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtEIdenName" runat="server"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="td">
                        ...
                        <ajaxToolkit:CollapsiblePanelExtender ID="CollapsiblePanelExtender1"
                            runat="server"
                            CollapseControlID="pnlBankHeading"
                            ExpandControlID="pnlBankHeading"
                            TargetControlID="pnlBankDescription"
                            Collapsed="true"
                            AutoCollapse="false"
                            AutoExpand="false"
                            ExpandDirection="Vertical"
                            ImageControlID="imbBank"
                        ...
                        <asp:Panel ID="pnlIdenHeading" runat="server" CssClass="Inser_Panel">
                            <table class="div" style="height: 20px; width: 812px; cursor: pointer; margin: 2px;">
                                <tr>
                                    <td>Identification Information
                                    </td>
                                    <td align="right">
                                        <asp:ImageButton ID="imbIden" runat="server" ImageUrl="~/resources/images/expand.jpg" AlternateText="IdenInfo" />
                                    </td>
                                </tr>
                            </table>
                        </asp:Panel>
                        <asp:Panel ID="pnlIdenContent" runat="server">
                            <div>
                                <table>
                                    <tr>
                                        <td>
                                            <asp:GridView ID="grdClientIdentification" runat="server" AllowPaging="True"
                                                PageSize="3" Width="812px" AllowSorting="True"
                                                DataSourceID="sdsClientIdentification" AutoGenerateColumns="False" DataKeyNames="CLINT_IDENT_ID"
                                                BorderColor="White" CssClass="mGrid" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                                                OnRowCancelingEdit="grdClientIdentification_RowCancelingEdit"
                                                OnRowEditing="grdClientIdentification_RowEditing"
                                                OnRowUpdated="grdClientIdentification_RowUpdated"
                                                OnPageIndexChanged="grdClientIdentification_PageIndexChanged"
                                                OnRowDeleted="grdClientIdentification_RowDeleted"
                                                OnRowDeleting="grdClientIdentification_RowDeleting"
                                                OnRowUpdating="grdClientIdentification_RowUpdating">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Identification Name"
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:DropDownList ID="DropDownList5" runat="server" DataValueField="IDNTIFCTION_ID"
                                                                DataTextField="IDNTIFCTION_NAME"
                                                                DataSourceID="sdsClientIdentificationSetUp"
                                                    ...
                                                    <asp:TemplateField HeaderText="ID" SortExpression="CLINT_IDENT_NAME">
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtEIdenName" runat="server" Text='<%# Bind("CLINT_IDENT_NAME") %>'></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <ItemTemplate>
                                                            <asp:Label ID="txtIIdenName" runat="server" Text='<%# Eval("CLINT_IDENT_NAME") %>'></asp:Label>
                                                        </ItemTemplate>
                            ...
                            SortExpression="CLINT_IDENT_NAME" />--%>
                                                    ...
                                                    <asp:TemplateField ShowHeader="False">
                                                        <EditItemTemplate>
                                                            <asp:Button ID="btnIdenUpdate" runat="server" CausesValidation="True"
                                                                CommandName="Update" Text="Update" />
                                                            &nbsp;<asp:Button ID="Button2" runat="server" CausesValidation="False"
                                                                CommandName="Cancel" Text="Cancel" />
                                                            <ajaxToolkit:ConfirmButtonExtender ID="cbeIdenUpdate" runat="server"
                                                                DisplayModalPopupID="ModalPopupExtender2" OnClientCancel="cancelClick"
                                                                TargetControlID="btnIdenUpdate">
                                                            </ajaxToolkit:ConfirmButtonExtender>
                                                            <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender2" runat="server"
                                                                BackgroundCssClass="modalBackground" CancelControlID="btnIdenUpdateCancel"
                                                                OkControlID="btnIdenUpdateOK" TargetControlID="btnIdenUpdate"
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Button ID="Button1" runat="server" CausesValidation="False"
                                                                CommandName="Edit" Text="Edit" />
                                                            &nbsp;<asp:Button ID="btnDeleteIden" runat="server" CausesValidation="False"
                                                                CommandName="Delete" Text="Delete" />
                                                            <ajaxToolkit:ConfirmButtonExtender ID="cbeIdenDelete" runat="server"
                                                                DisplayModalPopupID="ModalPopupExtender3" OnClientCancel="cancelClick"
                                                                TargetControlID="btnDeleteIden">
                                                            </ajaxToolkit:ConfirmButtonExtender>
                                                            <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender3" runat="server"
                                                                BackgroundCssClass="modalBackground" CancelControlID="btnIdenDeleteCancel"
                                                                OkControlID="btnIdenDeleteOK" TargetControlID="btnDeleteIden"
                                            ...
                                            <asp:Panel ID="pnlPopUpIdenUpdate" runat="server" Style="display: none; width: 300px; height: 165px; background-color: White; border-width: 1px; border-color: Silver; border-style: solid; padding: 1px;">
                                                <div style="height: 95px;">
                                                    <br />
                                                    &nbsp;<br />
                                                    &nbsp;
                  Are you sure you want to update?
                     <br />
                        ...
                        <asp:Button ID="btnIdenUpdateOK" runat="server" Text="  Yes  " />
                                            ...
                                            <asp:Panel ID="pnlPopUpIdenDelete" runat="server" Style="display: none; width: 300px; height: 165px; background-color: White; border-width: 1px; border-color: Silver; border-style: solid; padding: 1px;">
                                                <div style="height: 95px;">
                                                    <br />
                                                    &nbsp;<br />
                                                    &nbsp;
                   Are you sure you want to delete?
                    ...
                    <asp:Button ID="btnIdenDeleteOK" runat="server" Text="  Yes  " />
                        ...
                        <ajaxToolkit:CollapsiblePanelExtender ID="CollapsiblePanelExtender2"
                            runat="server"
                            CollapseControlID="pnlIdenHeading"
                            ExpandControlID="pnlIdenHeading"
                            TargetControlID="pnlIdenContent"
                            Collapsed="True"
                            AutoCollapse="false"
                            AutoExpand="false"
                            ExpandDirection="Vertical"
                            ImageControlID="imbIden"
                            CollapsedImage="~/resources/images/expand.jpg"
                            ExpandedImage="~/resources/images/collapse.jpg">
                        </ajaxToolkit:CollapsiblePanelExtender>
                        <asp:Panel ID="pnlIntrodheading" runat="server" CssClass="Inser_Panel">
                            <table style="height: 20px; width: 812px; cursor: pointer; margin: 2px;">
                                <tr>
                                    <td>Introducer Information
                                    </td>
                                    <td align="right">
                                        <asp:ImageButton ID="imbIntrod" runat="server" ImageUrl="~/resources/images/expand.jpg" AlternateText="IdenInfo" />
                                    </td>
                                </tr>
                            </table>
                        </asp:Panel>
                        <asp:Panel ID="pnlIntrodDescription" runat="server">
                            <div>
                                <table>
                                    <tr>
                                        <td>
                                            <asp:GridView ID="grdIntroducerInfo" runat="server" AllowPaging="True"
                                                PageSize="3" AllowSorting="True" DataSourceID="sdsIntroducerInformation"
                                                AutoGenerateColumns="False" DataKeyNames="INTRODCR_ID" Width="812px"
                                                BorderColor="White" CssClass="mGrid"
                                                PagerStyle-CssClass="pgr"
                                                AlternatingRowStyle-CssClass="alt"
                                                OnRowCancelingEdit="grdIntroducerInfo_RowCancelingEdit"
                                                OnRowEditing="grdIntroducerInfo_RowEditing"
                                                OnRowUpdated="grdIntroducerInfo_RowUpdated"
                                                OnPageIndexChanged="grdIntroducerInfo_PageIndexChanged"
                                                OnRowDeleted="grdIntroducerInfo_RowDeleted"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField ShowHeader="False">
                                                        <EditItemTemplate>
                                                            <asp:Button ID="btnIntrodUpdate" runat="server" CausesValidation="True"
                                                                CommandName="Update" Text="Update" />
                                                            &nbsp;<asp:Button ID="Button2" runat="server" CausesValidation="False"
                                                                CommandName="Cancel" Text="Cancel" />
                                                            <ajaxToolkit:ConfirmButtonExtender ID="cbeIntrodUpdate" runat="server"
                                                                DisplayModalPopupID="ModalPopupExtender2" OnClientCancel="cancelClick"
                                                                TargetControlID="btnIntrodUpdate">
                                                            </ajaxToolkit:ConfirmButtonExtender>
                                                            <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender2" runat="server"
                                                                BackgroundCssClass="modalBackground" CancelControlID="btnIntrodUpdateCancel"
                                                                OkControlID="btnIntrodUpdateOK" TargetControlID="btnIntrodUpdate"
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Button ID="Button1" runat="server" CausesValidation="False"
                                                                CommandName="Edit" Text="Edit" />
                                                            &nbsp;<asp:Button ID="btnDeleteIntrod" runat="server" CausesValidation="False"
                                                                CommandName="Delete" Text="Delete" />
                                                            <ajaxToolkit:ConfirmButtonExtender ID="cbeIntrodDelete" runat="server"
                                                                DisplayModalPopupID="ModalPopupExtender3" OnClientCancel="cancelClick"
                                                                TargetControlID="btnDeleteIntrod">
                                                            </ajaxToolkit:ConfirmButtonExtender>
                                                            <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender3" runat="server"
                                                                BackgroundCssClass="modalBackground" CancelControlID="btnIntrodDeleteCancel"
                                                                OkControlID="btnIntrodDeleteOK" TargetControlID="btnDeleteIntrod"
                                            ...
                                            <asp:Panel ID="pnlPopUpIntrodUpdate" runat="server" Style="display: none; width: 300px; height: 165px; background-color: White; border-width: 1px; border-color: Silver; border-style: solid; padding: 1px;">
                                                <div style="height: 95px;">
                                                    <br />
                                                    &nbsp;<br />
                                                    &nbsp;
                  Are you sure you want to update?
                     <br />
                        ...
                        <asp:Button ID="btnIntrodUpdateOK" runat="server" Text="  Yes  " />
                                            ...
                                            <asp:Panel ID="pnlPopUpIntrodDelete" runat="server" Style="display: none; width: 300px; height: 165px; background-color: White; border-width: 1px; border-color: Silver; border-style: solid; padding: 1px;">
                                                <div style="height: 95px;">
                                                    <br />
                                                    &nbsp;<br />
                                                    &nbsp;
                   Are you sure you want to delete?
                    ...
                    <asp:Button ID="btnIntrodDeleteOK" runat="server" Text="  Yes  " />
                        ...
                        <ajaxToolkit:CollapsiblePanelExtender ID="CollapsiblePanelExtender3"
                            runat="server"
                            CollapseControlID="pnlIntrodheading"
                            Collapsed="True"
                            ExpandControlID="pnlIntrodheading"
                            TargetControlID="pnlIntrodDescription"
                            AutoCollapse="false"
                            AutoExpand="false"
                            ExpandDirection="Vertical"
                            ImageControlID="imbIntrod"
                            CollapsedImage="~/resources/images/expand.jpg"
                            ExpandedImage="~/resources/images/collapse.jpg">
                        </ajaxToolkit:CollapsiblePanelExtender>
                        ...
                        <asp:Panel ID="pnlNominiheading" runat="server" CssClass="Inser_Panel">
                            <table class="div" style="height: 20px; width: 812px; cursor: pointer; margin: 2px;">
                                <span>
                                    <tr>
                                        <td>Nominee Information
                                        </td>
                                        <td align="right">
                                            <asp:ImageButton ID="imbNominee" runat="server" ImageUrl="~/resources/images/expand.jpg" AlternateText="IdenInfo" />
                                        </td>
                                    </tr>
                                </span>
                            </table>
                                    ...
                                    <tr>
                                        <td valign="top">
                                            <asp:GridView ID="grdNomineeInfo" runat="server" AllowPaging="True" PageSize="3"
                                                AllowSorting="True" DataSourceID="sdsNomineeInformation"
                                                AutoGenerateColumns="False" DataKeyNames="NOMNE_ID" Width="812px"
                                                BorderColor="White" CssClass="mGrid"
                                                PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                                                OnRowCancelingEdit="grdNomineeInfo_RowCancelingEdit"
                                                OnRowEditing="grdNomineeInfo_RowEditing"
                                                OnRowUpdated="grdNomineeInfo_RowUpdated"
                                                OnPageIndexChanged="grdNomineeInfo_PageIndexChanged"
                                                OnRowDeleted="grdNomineeInfo_RowDeleted"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="RELATION" HeaderText="Relation"
                                                        SortExpression="RELATION" HeaderStyle-Width="80px">
                                                        <ControlStyle Width="80px" />
                                                        <HeaderStyle Width="80px" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="PERCENTAGE" HeaderText="Percentage(%)"
                                                        SortExpression="PERCENTAGE" HeaderStyle-Width="90px">
                                                        <ControlStyle Width="90px" />
                                                        <HeaderStyle Width="90px" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="REMARKS" HeaderText="Remarks"
                                                        SortExpression="REMARKS" HeaderStyle-Width="60px">
                                                        <ControlStyle Width="60px" />
                                                        <HeaderStyle Width="60px" />
                                                    </asp:BoundField>
                                                    <asp:TemplateField ShowHeader="False">
                                                        <EditItemTemplate>
                                                            <asp:Button ID="btnNominiUpdate" runat="server" CausesValidation="True"
                                                                CommandName="Update" Text="Update" />
                                                            &nbsp;<asp:Button ID="Button2" runat="server" CausesValidation="False"
                                                                CommandName="Cancel" Text="Cancel" />
                                                            <ajaxToolkit:ConfirmButtonExtender ID="cbeNominiUpdate" runat="server"
                                                                DisplayModalPopupID="ModalPopupExtender2" OnClientCancel="cancelClick"
                                                                TargetControlID="btnNominiUpdate">
                                                            </ajaxToolkit:ConfirmButtonExtender>
                                                            <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender2" runat="server"
                                                                BackgroundCssClass="modalBackground" CancelControlID="btnNominiUpdateCancel"
                                                                OkControlID="btnNominiUpdateOK" TargetControlID="btnNominiUpdate"
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Button ID="Button1" runat="server" CausesValidation="False"
                                                                CommandName="Edit" Text="Edit" />
                                                            &nbsp;<asp:Button ID="btnDeleteNomini" runat="server" CausesValidation="False"
                                                                CommandName="Delete" Text="Delete" />
                                                            <ajaxToolkit:ConfirmButtonExtender ID="cbeNominiDelete" runat="server"
                                                                DisplayModalPopupID="ModalPopupExtender3" OnClientCancel="cancelClick"
                                                                TargetControlID="btnDeleteNomini">
                                                            </ajaxToolkit:ConfirmButtonExtender>
                                                            <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender3" runat="server"
                                                                BackgroundCssClass="modalBackground" CancelControlID="btnNominiDeleteCancel"
                                                                OkControlID="btnNominiDeleteOK" TargetControlID="btnDeleteNomini"
                                            ...
                                            <asp:Panel ID="pnlPopUpNominiUpdate" runat="server" Style="display: none; width: 300px; height: 165px; background-color: White; border-width: 1px; border-color: Silver; border-style: solid; padding: 1px;">
                                                <div style="height: 95px;">
                                                    <br />
                                                    &nbsp;<br />
                                                    &nbsp;
                  Are you sure you want to update?
                     <br />
                        ...
                        <asp:Button ID="btnNominiUpdateOK" runat="server" Text="  Yes  " />
                                            ...
                                            <asp:Panel ID="pnlPopUpNominiDelete" runat="server" Style="display: none; width: 300px; height: 165px; background-color: White; border-width: 1px; border-color: Silver; border-style: solid; padding: 1px;">
                                                <div style="height: 95px;">
                                                    <br />
                                                    &nbsp;<br />
                                                    &nbsp;
                   Are you sure you want to delete?
                    ...
                    <asp:Button ID="btnNominiDeleteOK" runat="server" Text="  Yes  " />
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="display: none">
                                                        <asp:DropDownList ID="ddlRELATIONSHIP" runat="server" Width="145px"
                                                            DataSourceID="sdsRELATIONSHIP" AutoPostBack="true"
                                                            AppendDataBoundItems="true" DataTextField="RELATIONSHIP_TITLE"
                                                            DataValueField="RELATIONSHIP_ID">
                                                        </asp:DropDownList>
                                                    </td>
                        ...
                        <ajaxToolkit:CollapsiblePanelExtender ID="CollapsiblePanelExtender4"
                            runat="server"
                            TargetControlID="pnlNominiDescription"
                            CollapseControlID="pnlNominiheading"
                            ExpandControlID="pnlNominiheading"
                            Collapsed="True"
                            AutoCollapse="false"
                            AutoExpand="false"
                            ExpandDirection="Vertical"
                            ImageControlID="imbNominee"
                            CollapsedImage="~/resources/images/expand.jpg"
                            ExpandedImage="~/resources/images/collapse.jpg">
                        </ajaxToolkit:CollapsiblePanelExtender>
                        <table width="714px">
                      ...
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     <asp:Button ID="txtUpdate" runat="server" Text="Save"
                         OnClick="txtUpdate_Click" Width="69px" ValidationGroup="Update" />

                                    <ajaxToolkit:ConfirmButtonExtender ID="ConfirmButtonExtender1" runat="server"
                                        DisplayModalPopupID="ModalPopupExtender1" OnClientCancel="cancelClick"
                                        TargetControlID="txtUpdate">
                                    </ajaxToolkit:ConfirmButtonExtender>
                                    <ajaxToolkit:ModalPopupExtender ID="ModalPopupExtender1" runat="server"
                                        BackgroundCssClass="modalBackground" CancelControlID="ButtonCancel"
                                        OkControlID="ButtonOk" TargetControlID="txtUpdate" PopupControlID="pnlPopUp">
                                    </ajaxToolkit:ModalPopupExtender>
