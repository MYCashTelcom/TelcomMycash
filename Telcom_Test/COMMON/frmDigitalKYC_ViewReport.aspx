<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmDigitalKYC_ViewReport.aspx.cs" Inherits="COMMON_frmDigitalKYC_ViewReport" %>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvRemarks" runat="server"
                                            ...
                                            ValidationGroup="UpdateCancel" Display="Dynamic">
                                        </asp:RequiredFieldValidator></td>
                                    <%--<td colspan="2"></td>--%>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" align="center">
                                        ...
                                        <asp:Button ID="btnUpdate" runat="server" Text="  Verify  " ValidationGroup="Update" OnClick="btnUpdate_Click" />
