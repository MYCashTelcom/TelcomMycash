<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmMngAccount.aspx.cs"
...
ORDER BY TRIM(CL.CLINT_NAME)">
                  ...
                  SelectCommand="SELECT RANK_TITEL,ACCNT_RANK_ID FROM ACCOUNT_RANK WHERE SHORT_CODE IN ('NA','D','SD','SA','A','C','MCPAY','D2D', 'PWA', 'MPAG', 'MAG','OA','ODSE','OD','OMD','OSM','OMM') ORDER BY ACCNT_RANK_ID">
                        </asp:SqlDataSource>
